...
def api_request(endpoint):
    ...
    if endpoint == "sources":
        ...
        request_url = base_url.format("everything", api_key) + "&sortBy=popularity&pageSize=35" # Using everything endpoint to enable removing articles not written in English
    else:
        request_url = None
